...
- [Middleware Stack and Request Processing](middleware-stack.md) - Ordered middleware around model and tool loops. Covers preparation, policy, retries, deadlines, completion hooks, follow-up handling, and safe error boundaries.
